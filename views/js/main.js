...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImageContainer.classList.add("col-md-6", "col-sm-5", "col-xs-4");
  ...
  pizzaDescriptionContainer.classList.add("col-md-6", "col-sm-5", "col-xs-4");
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // DOM lookups are time consuming, thus create variable to refer to document.querySelectorAll(".randomPizzaContainer");
    var pizzaSizes = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < pizzaSizes.length; i++) {
      var dx = determineDx(pizzaSizes[i], size);
      var newwidth = (pizzaSizes[i].offsetWidth + dx) + 'px';
      console.log(pizzaSizes[i].offsetWidth)
